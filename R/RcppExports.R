...
logLikCpp <- function(edgeMat, clusterMRCAs, limProbsVec, withinTransMatList, betweenTransMatList, numThreads, alignmentBin, numTips, numLoci, withinMatListIndex, betweenMatListIndex) {
    .Call('DMphyClus_logLikCpp', PACKAGE = 'DMphyClus', edgeMat, clusterMRCAs, limProbsVec, withinTransMatList, betweenTransMatList, numThreads, alignmentBin, numTips, numLoci, withinMatListIndex, betweenMatListIndex)
}
